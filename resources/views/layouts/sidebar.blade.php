    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{ url('/') }}" class="b-brand text-primary">
                ...
                <img src="{{ asset('assets/images/logo-travel-malang-new.png') }}" alt="Logo" class="logo logo-lg" style="width: 70%" />
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{ url('/dataset') }}" class="pc-link">
                        <span class="pc-micon">
                            <i class="ti ti-typography"></i>
                        </span>
                        <span class="pc-mtext">Dataset</span>
                    </a>
                </li>
                <li class="pc-item">
                ...
                <li class="pc-item">
                    <a href="../pages/login-v3.html" class="pc-link" target="_blank">
                        <span class="pc-micon">
                ...
                <li class="pc-item">
                    <a href="../pages/register-v3.html" class="pc-link" target="_blank">
                        <span class="pc-micon">
